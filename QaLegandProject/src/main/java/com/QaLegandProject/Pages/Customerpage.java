...
public class Customerpage {
	...
	{
		PageUtilities.clickOnElement(status);
		PageUtilities.selectClassDropdown(dropStatus).selectByVisibleText(value);
    }
	public String checkingStatus()
	{
		return statusProgress.getText();
		
	}*/
	public void uploadFile(String path)
	{
		PageUtilities.clickOnElement(addRepar);
		/*PageUtilities.clickOnElement(uploadPicture);
		PageUtilities.clickOnElement(browser);
		browser.sendKeys(path);
		PageUtilities.clickOnElement(uploadClick);*/
